...
import 'package:flutter_pos_printer_platform_image_3/src/utils.dart' as utils;
...
class EscPosPrinter<T> extends GenericPrinter<T> {
  ...
  Future<bool> image(Uint8List image, {int threshold = 150}) async {
    ...
    final converted = toPixel(utils.ImageData(width: decodedImage.width, height: decodedImage.height), paperWidth: width, dpi: dpi, isTspl: false);
